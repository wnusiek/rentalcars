...
public class DbInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        var car1 = carRepository.save(new CarModel(1l, "Opel", "Corsa", BigDecimal.ONE, BigDecimal.valueOf(500), "Sedan", "automatyczna", 5, 4, "benzyna", "aaa", true, new Date(1999),195000,"Red"));
        var car2 = carRepository.save(new CarModel(2l, "Opel", "Astra", BigDecimal.ONE, BigDecimal.valueOf(500), "Sedan", "automatyczna", 5, 4, "olej", "aaa", true, new Date(2019), 45000, "Black"));
